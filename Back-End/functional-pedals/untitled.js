...
window.untitled = class untitled {
  ...
  load() {
    return new Promise((resolve, reject) => {
      let real_url =
        this.baseURL === ""
          ? "untitled-processor.js"
          : this.baseURL + "/untitled-processor.js";
      this.context.audioWorklet
        .addModule(real_url)
        .then(() => {
          this.node = new untitledNode(this.context, this.baseURL, {});
          this.node.onprocessorerror = () => {
            console.log("An error from untitled-processor was detected.");
          };
          return this.node;
        })
        .then(node => {
