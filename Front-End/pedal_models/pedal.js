(function (window, document, undefined) {
    ...
    class Pedal extends HTMLElement {
        ...
        getAttributes() {
            return ['color', 'width', 'height', 'radius', 'background-image', 'opacity', 'name'];
        }
        ...
        getElements() {
            return this.knobs.concat(this.icons.concat(this.switches.concat(this.sliders.concat(this.labels))));
        }
        ...
        setBackgroundImage(imageName) {
            if (imageName) {
                ...
                backgroundImageElem.setAttribute('src', ASSETS_PATH + '/background/' + imageName);
        ...
        loadConfig(config) {
            ...
            for (let element of config.elements) {
                console.log("loadConfig: element.type = " + element.type + " element.label=" + element.label)
                if (element.type == 'knob') {
                    ...
                    console.log("LoadConfig: label = " + knob.id + " step = " + knob.step)
